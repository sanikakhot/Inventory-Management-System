...
class employeeClass:
    def __init__(self,root):
        ...
        lbl_gemder=Label(self.root,text="Gender",font=("goudy old style",15),bg="white").place(x=350,y=150)
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Comferm","Do you really want to delete?",parent=self.root)
                    if op==True:

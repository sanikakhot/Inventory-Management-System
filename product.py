...
#============================== frame ===================================
    ...
    #=============================colum2==============================
        ...
        lbl_produvr_name=Label(self.root,text="Name",font=("goudy old style",18),bg="white").place(x=30,y=160)
        lbl_price=Label(self.root,text="Price",font=("goudy old style",18),bg="white").place(x=30,y=210)
        lbl_qty=Label(self.root,text="Quantity",font=("goudy old style",18),bg="white").place(x=30,y=260)
        ...
        try:
            if self.var_pid.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Comfirm","Do you really want to delete?",parent=self.root)
                    if op==True:

...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed By Sanika Khot")
        ...
        lbl_search=Entry(ProductFrame2,textvariable=self,font=("times new roman",15),bg="lightyellow").place(x=128,y=47,width=150,height=22)
        ...
        #================================= Footer ================================
        footer=Label(self.root,text=("IMS-Inventary Management System | Developed By Sanika Khot\nFor any Technical Issue contact: 8767124459"),font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.show()
       # self.bill_top()
#============================= All Function =======================================
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            for row in self.cart_list:
                ...
                index_+=1
            if present=='yes':
                op=messagebox.askyesno('confirm',"Product already present \n Do you want to Update | Remove from the cart List",present=self.root)
                if op==True:
